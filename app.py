...
sample_img = cv2.imread('NCBC1.png')
...
#     'Class.txt:', type=['txt']
# )
# path_to_class_txt=['Car','Person','Bus','Motor Cycle','Truck','Rickshaw']
...
if path_to_class_txt is not None:
        ...
        if upload_img_file is not None:
            ...
            if pred:
                ...
                for i in range (int(p)):
                    dict2["Date"].append(str(datetime.now())[:10])
                    dict2["Time"].append(str(datetime.now())[11:19])
                    dict2["Day"].append(datetime.now().strftime('%A'))
    ...
    if options == 'RTSP':
        ...
        #     'RTSP URL:',
        #     'rtsp://admin:ncbc1234@192.168.18.204:2000')
        rtsp_url =st.sidebar.selectbox('Camera IP',
                                           ('rtsp://admin:ncbc1234@192.168.18.203', 
                                           'rtsp://admin:ncbc1234@192.168.18.204:2000', 
                                           'rtsp://admin:ncbc1234@192.168.18.202',
                                           'rtsp://admin:ncbc1234@192.168.18.207'))
        ...
        # cap = cv2.VideoCapture(f'{rtsp_url}&subtype=0')
